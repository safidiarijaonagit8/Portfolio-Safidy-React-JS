const INFO = {
	main: {
		title: "Portfolio Safidiarijaona",
		name: "Safidiarijaona",
		email: "safidiarijaonatokiniaina@gmail.com",
		logo: "../logo2.png",
	},

	socials: {
		facebook: "https://facebook.com/safidiarijaona",
		github: "https://github.com/safidiarijaonagit8",
		linkedin: "https://www.linkedin.com/in/safidiarijaona/",
	...
	about: {
		title: "Je suis Safidiarijaona. J'habite à Antananarivo, Je suis développeur.",
		description:
			" Diplômé en Licence informatique, désireux de relever de nouveaux challenges, également motivé pour apprendre, respectueux, enthousiaste, assidu et persévérant, je souhaiterai rejoindre vos effectifs afin de participer aux développements de vos projets. J' ai travaillé sur de nombreux projets depuis des années maintenant, et je suis assez fier de mon évolution.",
	},
	...
	projects: [
		...
		{
			title: "Calcul de l' amortissement d' une immobilisation",
			description:
				"C' est un projet qui calcule le tableau d'amortissement d' une immobilisation donnée. Ce projet propose quelques fonctionnalités en plus, comme l' ajout d'une immobilisation, le calcul du tableau d'ammortissement de toutes les immobilisations pour une année choisie et l'export PDF du tableau d'ammortissement. J'ai utilisé le framework SPRINGBOOT avec la base de données MySQL ",
			logo: "../springboot.png",
			linkText: "Voir sur github",
